...
(RDST-RF-5K) with attribute selection
...
to select the top 5000 features
...
__all__ = ["RDSTClassifier_rotation_pipeline_3"]
...
class RDSTClassifier_rotation_pipeline_3(BaseClassifier):
    """
    ...
    def _fit_rdst_shared(self, X, y):
        ...
        self._selector = SelectKBest(score_func=mutual_info_classif, k=min(5000, X_t.shape[1]))
