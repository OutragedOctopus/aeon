...
__author__ = ["baraline"]
__all__ = ["RandomDilatedShapeletTransform_modified"]
...
class RandomDilatedShapeletTransform_modified(BaseCollectionTransformer):
    ...
    def __init__(
        ...
        super(RandomDilatedShapeletTransform_modified, self).__init__()
...
def _init_random_shapelet_params(
    ...
    #CANCEL OUT DILATIONS!!!
    dilations = np.ones(max_shapelets, dtype=np.int32)
    #END OF CANCELLING DILATIONS
