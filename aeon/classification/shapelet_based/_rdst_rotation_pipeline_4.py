...
(RDST-RF-2.5K) with attribute selection
...
to select the top 2500 features
...
__all__ = ["RDSTClassifier_rotation_pipeline_4"]
...
class RDSTClassifier_rotation_pipeline_4(BaseClassifier):
    """
    ...
    def _fit(self, X, y):
        ...
        self._selector = SelectKBest(score_func=mutual_info_classif, k=min(2500, X_t.shape[1]))
