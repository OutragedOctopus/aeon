...
__all__ = ["MrSQMClassifier", "ShapeletTransformClassifier", "RDSTClassifier", "RDSTClassifier_modified"]
...
from aeon.classification.shapelet_based._rdst_modified import RDSTClassifier_modified
