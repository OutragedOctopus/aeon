"""Random Dilated Shapelet Transform with Rotation Forest classifier (RDST-RF).
...
class RDSTClassifier_rotation_only(BaseClassifier):
    """
    A random dilated shapelet transform (RDST) classifier with a Rotation Forest classifier downstream.
